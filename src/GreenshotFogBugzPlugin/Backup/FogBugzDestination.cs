...
namespace GreenshotFogBugzPlugin  {
	public class FogBugzDestination : AbstractDestination {
		private static log4net.ILog LOG = log4net.LogManager.GetLogger(typeof(FogBugzDestination));
		private static FogBugzConfiguration config = IniConfig.GetIniSection<FogBugzConfiguration>();
		private FogBugzPlugin plugin = null;
		...
		public override string Description {
			get {
				return Language.GetString("fogbugz", LangKey.upload_menu_item);
			}
		}
